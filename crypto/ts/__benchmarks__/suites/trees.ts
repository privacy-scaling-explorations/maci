...
export default function runTrees(): void {
  ...
  benny.suite(
    ...
    benny.save({ folder: "benchmarks/results", file: NAME, version: "1.0.0", details: true }),
    benny.save({ folder: "benchmarks/results", file: NAME, format: "chart.html", details: true }),
    benny.save({ folder: "benchmarks/results", file: NAME, format: "table.html", details: true }),
  );
}
