...
NODE_OPTIONS=--max-old-space-size=16384 time node --stack-size=16384 build/buildSnarks.js -i circom/prod/quadVoteTally_small.circom -j build/qvtCircuitSmall.r1cs -w build/qvtSmall.wasm -p build/qvtPkSmall.bin -v build/qvtVkSmall.json -s build/QuadVoteTallyVerifier.sol -vs QuadVoteTallyVerifier -z build/qvtSmall.zkey
