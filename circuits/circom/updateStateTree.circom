...
template PerformChecksBeforeUpdate(
    ...
    component msg_hash = Hasher11(MESSAGE_LENGTH);
    msg_hash.key <== 0;
    for (var i = 0; i < MESSAGE_LENGTH; i++) {
    ...
    component existing_state_tree_leaf_hash = Hasher5(STATE_TREE_DATA_LENGTH);
...
template UpdateStateTree(
    ...
    component new_state_tree_leaf = Hasher5(STATE_TREE_DATA_LENGTH);
