...
describe("e2e tests with full spent voting", function test() {
  ...
  const generateProofsArgs: Omit<IGenerateProofsArgs, "maciAddress" | "signer"> = {
    ...
    tallyZkey: testTallyVotesFullZkeyPath,
    processZkey: testProcessMessageFullZkeyPath,
    pollId: 0n,
    rapidsnark: testRapidsnarkPath,
    processWitgen: testProcessMessagesFullWitnessPath,
    processDatFile: testProcessMessagesFullWitnessDatPath,
    tallyWitgen: testTallyVotesFullWitnessPath,
    tallyDatFile: testTallyVotesFullWitnessDatPath,
    coordinatorPrivateKey,
    processWasm: testProcessMessagesFullWasmPath,
    tallyWasm: testTallyVotesFullWasmPath,
    useWasm,
    mode: EMode.FULL,
  };
