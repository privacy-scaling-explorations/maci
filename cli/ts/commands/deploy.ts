...
export const deploy = async (
    ...
    const vkRegistry = vkRegistryAddress
        ? vkRegistryAddress
        : vkRegistryContractAddress;

    if (initialVoiceCreditsProxyAddress && initialVoiceCredits) {
        logError(
            "Please provide either an initialVoiceCreditProxyAddress or initialVoiceCredits, not both"
        );
    }
    ...
    let signupGatekeeperContractAddress =
        readContractAddress("SignUpGatekeeper");
