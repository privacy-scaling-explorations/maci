...
import { calcBinaryTreeDepthFromMaxLeaves, calcQuinTreeDepthFromMaxLeaves } from "./utils";

import { timeTravel, configureSubparser as configureSubparserForTimeTravel } from "./timeTravel";

import { genMaciKeypair, configureSubparser as configureSubparserForGenMaciKeypair } from "./genMaciKeypair";

import { genMaciPubkey, configureSubparser as configureSubparserForGenMaciPubkey } from "./genMaciPubkey";

import { deployVkRegistry, configureSubparser as configureSubparserForDeployVkRegistry } from "./deployVkRegistry";

import { setVerifyingKeys, configureSubparser as configureSubparserForSetVerifyingKeys } from "./setVerifyingKeys";

import { create, configureSubparser as configureSubparserForCreate } from "./create";

import { deployPoll, configureSubparser as configureSubparserForDeployPoll } from "./deployPoll";
...
import { fundWallet, configureSubparser as configureSubparserForFundWallet } from "./fundWallet";

import { airdrop, configureSubparser as configureSubparserForAirdrop } from "./airdrop";

import { topup, configureSubparser as configureSubparserForTopup } from "./topup";

import { signup, configureSubparser as configureSubparserForSignup } from "./signUp";

import { publish, configureSubparser as configureSubparserForPublish } from "./publish";

import { mergeMessages, configureSubparser as configureSubparserForMergeMessages } from "./mergeMessages";

import { mergeSignups, configureSubparser as configureSubparserForMergeSignups } from "./mergeSignups";

import { genProofs, configureSubparser as configureSubparserForGenProofs } from "./genProofs";

import { proveOnChain, configureSubparser as configureSubparserForProveOnChain } from "./proveOnChain";

import { verify, configureSubparser as configureSubparserForVerify } from "./verify";

import { checkVerifyingKey, configureSubparser as configureSubparserForCheckVerifyKey } from "./checkVerifyingKey";
import { genLocalState, configureSubparser as configureSubparserForGenerateLocalState } from "./genLocalState";
