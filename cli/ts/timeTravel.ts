...
const configureSubparser = (subparsers: any) => {
  const createParser = subparsers.addParser("timeTravel", { addHelp: true });

  createParser.addArgument(["-s", "--seconds"], {
    action: "store",
    required: true,
    type: "int",
  ...
  createParser.addArgument(["-e", "--eth-provider"], {
    action: "store",
    type: "string",
...
export { timeTravel, configureSubparser };
