...
describe("e2e with Subsidy tests", function () {
  ...
  describe("test1", () => {
    ...
    it("should generate zk-SNARK proofs and verify them", async () => {
      ...
      await verify("0", testTallyFilePath, undefined, undefined, undefined, testSubsidyFilePath);
    });
  });
  ...
  describe("multiplePolls1", () => {
    ...
    it("should generate proofs and verify them", async () => {
      ...
      await verify("1", testTallyFilePath, undefined, undefined, undefined, testSubsidyFilePath);
    });
  });
  ...
  describe("multiplePolls2", () => {
    ...
    it("should complete the third poll", async () => {
      ...
      await verify("2", testTallyFilePath, undefined, undefined, undefined, testSubsidyFilePath);
    });
  });
});
