...
# TODO: check new-key-generation-zkey dir name

$MACI_CLI generateNewKey \
    --new-pub-key macipk.e57109205d2b33b90db8421727a2d4fb91cdf3a8e050fbd12aa5a9f4045585a2 \
    --new-priv-key macisk.acd54022725c8cf56dcd392808e3c4d170100d9fba4009ef0e8173ffe17f2e0 \
    ...
    --coord-priv-key macisk.49953af3585856f539d194b46c82f4ed54ec508fb9b882940cbe68bbc57e59e \
    --state-index 1 \
    --salt 0x798D81BE4A9870C079B8DE539496AB95 \
    --poll-id $POLL_ID \
    --from-block 0 \
