...
const genTestUserCommands = (
  ...
  for (let i = 0; i < numUsers; i++) {
    ...
    const userCommand = new UserCommand(userKeypair, votes, config.defaultVote.maxVoteWeight, config.defaultVote.nonce);
...
const expectSubsidy = (maxMessages: number, expectedSubsidy: number[], SubsidyFile: Subsidy) => {
