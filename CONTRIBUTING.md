...
5. Make sure to check out the [Style Guide](/CONTRIBUTING#style-guide) and ensure that your code complies with the rules.
...
Please refer to our [testing guide](https://maci.pse.dev/docs/testing) for more details on how we run tests across the monorepo.
