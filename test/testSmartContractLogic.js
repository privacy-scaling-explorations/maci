...
const { randomPrivateKey, privateToPublicKey, signAndEncrypt } = require('../_build/utils/crypto')

const ethers = require('ethers')
const provider = new ethers.providers.JsonRpcProvider(ganacheConfig.host)

describe('Smart Contract Logic', () => {
  ...
  it('Smart Contract sequence of actions', async () => {
