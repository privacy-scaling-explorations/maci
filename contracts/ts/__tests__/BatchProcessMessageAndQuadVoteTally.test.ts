...
describe('BatchProcessMessage', () => {
    ...
    describe('Process messages', () => {
        ...
        it('batchProcessMessage should verify a proof and update the stateRoot', async () => {
            ...
            const { witness, proof, publicSignals }
            ...
            const circuitNewStateRoot = getSignalByNameViaSym('batchUst', witness, 'main.root')
    ...
    describe('Tally votes', () => {
        ...
        it('should tally a batch of votes', async () => {
            ...
            const newResultsCommitmentOutput = getSignalByNameViaSym('qvt', witness, 'main.newResultsCommitment')
            ...
            const newSpentVoiceCreditsCommitmentOutput = getSignalByNameViaSym('qvt', witness, 'main.newSpentVoiceCreditsCommitment')
            ...
            const newPerVOSpentVoiceCreditsCommitmentOutput = getSignalByNameViaSym('qvt', witness, 'main.newPerVOSpentVoiceCreditsCommitment')
