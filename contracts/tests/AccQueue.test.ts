...
const testFillForAllIncompletes = async (aq: AccQueue, aqContract: any, HASH_LENGTH: number) => {
 ...
 */
const testEnqueue = async (aqContract: any, HASH_LENGTH: number, SUB_DEPTH: number, ZERO: bigint) => {
 ...
 */
const testInsertSubTrees = async (aq: AccQueue, aqContract: any, NUM_SUBTREES: number, MAIN_DEPTH: number) => {
  const leaves: bigint[] = [];
 ...
 */
const testMerge = async (aq: AccQueue, aqContract: any, NUM_SUBTREES: number, MAIN_DEPTH: number) => {
 ...
 */
const testMergeAgain = async (aq: AccQueue, aqContract: any, MAIN_DEPTH: number) => {
  const tree = new IncrementalQuinTree(MAIN_DEPTH, aq.zeros[0], aq.hashLength, aq.hashFunc);
