...
contract MockVerifier is IVerifier, SnarkConstants {
  ...
  function verify(uint256[8] memory, VerifyingKey memory, uint256) public view override returns (bool) {
    return result;
  }
}
...
contract Verifier is IVerifier, SnarkConstants {
  ...
  function verify(uint256[8] memory _proof, VerifyingKey memory vk, uint256 input) public view override returns (bool) {
    ...
    return Pairing.pairing(Pairing.negate(proof.a), proof.b, vk.alpha1, vk.beta2, vk_x, vk.gamma2, proof.c, vk.delta2);
  }
}
