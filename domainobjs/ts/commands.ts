import { decrypt, encrypt, genRandomSalt, hash4, sign, verifySignature, Signature, Ciphertext, EcdhSharedKey } from "maci-crypto"
...
export class PCommand extends Command {
	...
	constructor(
		...
		nonce: bigint,
		pollId: bigint,
		salt: bigint = genRandomSalt() as bigint 
	) {
		super(BigInt(1));
