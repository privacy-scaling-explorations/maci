...
describe('Domain objects', () => {
    ...
    describe('Verifying keys', () => {
        it('Should convert a JSON file from snarkjs to a VerifyingKey', () => {
            ...
            expect(d.vk_beta_2[0][0]).toEqual(vk.beta2.x[0].toString())
            expect(d.vk_beta_2[0][1]).toEqual(vk.beta2.x[1].toString())
            expect(d.vk_beta_2[1][0]).toEqual(vk.beta2.y[0].toString())
            expect(d.vk_beta_2[1][1]).toEqual(vk.beta2.y[1].toString())

            expect(d.vk_gamma_2[0][0]).toEqual(vk.gamma2.x[0].toString())
            expect(d.vk_gamma_2[0][1]).toEqual(vk.gamma2.x[1].toString())
            expect(d.vk_gamma_2[1][0]).toEqual(vk.gamma2.y[0].toString())
            expect(d.vk_gamma_2[1][1]).toEqual(vk.gamma2.y[1].toString())

            expect(d.vk_delta_2[0][0]).toEqual(vk.delta2.x[0].toString())
            expect(d.vk_delta_2[0][1]).toEqual(vk.delta2.x[1].toString())
            expect(d.vk_delta_2[1][0]).toEqual(vk.delta2.y[0].toString())
            expect(d.vk_delta_2[1][1]).toEqual(vk.delta2.y[1].toString())
